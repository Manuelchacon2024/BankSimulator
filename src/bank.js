...
function aboutUs(){
    alert("The Bank Supérate! It's a project made by the first-year students of the center ¡Supérate! Hilasal, which aims to have the operation of an ATM online; in which, we have been able to test our knowledge and also apply all the knowledge acquired in it. \nThis bank was created by the students: \nMichael Ramírez, Daniela Rodríguez, Jairo Guzmán, Daniela Martínez and Geisel Ortis. \nWithout a doubt, this has been a very challenging experience and at the same time we have acquired a lot of knowledge.")
}
